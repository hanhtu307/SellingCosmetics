...
$productVariants = [
    12 => [
        ['name' => 'Hồng - Vàng - Tím', 'img' => 'assets/images/a25.jpg', 'price' => 266000],
        ['name' => 'Hồng - Vàng - Xanh', 'img' => 'assets/images/a24.jpg', 'price' => 266000]
    ],
    12 => [
...
switch ($sort) {
    ...
    case 'popular':
    default:
        $orderBy = 'sold DESC'; // Sắp xếp theo số lượng đã bán (bán chạy)
        break;
}

// Handle pagination
$productsPerPage = 12; // Align with home.php
$currentPage = isset($_GET['page']) && is_numeric($_GET['page']) ? (int)$_GET['page'] : 1;
if ($currentPage < 1) $currentPage = 1;
$offset = ($currentPage - 1) * $productsPerPage;

// Count total products
$countSql = "SELECT COUNT(*) as total FROM products WHERE category = 'skincare'";
...
<head>
    <meta charset="UTF-8">
    <title>Skincare - Luna Beauty</title>
    ...
    <header>
        ...
        <div class="topbar">
            <a href="home.php" class="logo">
                <img src="assets/images/logo1.png" alt="Luna Beauty" style="height: 90px;">
            </a>
